...
namespace ErikTheCoder.Sandbox.Baseball.App
{
    public static class Program
    {
        ...
        private static void PrintSalaries(ITeam Team)
        {
            ...
            foreach (var teamMember in teamMembers) ThreadsafeConsole.WriteLine($"{teamMember.Name, -_namePadding}{teamMember.Salary, _namePadding:C0}");
        ...
        private static void PopulateCubs1984Team(IBaseballRepo Repo, ITeam Team)
        {
            ...
            // Add coaches.
            var headCoach = Repo.CreateCoach();
